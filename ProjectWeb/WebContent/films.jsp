...
%>
		...
		<section>
			...
			<%
				...
				if (request.getAttribute("id_film") == null)
    			{
			%>
					<div id="lien">
						<p> <a href="accueil.jsp">Accueil</a> › <a href="List_Films">Films</a> </p>
					</div>

			<%
					//affichage films de la semaine actuelle
					if (request.getParameter("view") == null || request.getParameter("view").equals("now"))
					{
			%>

			<%@
						include file="films_actuels.jsp"
			%>

			<%
					}
					//affichage de tous les films
					else if (request.getParameter("view").equals("all"))
					{
			%>

			<%@
						include file="tous_les_films.jsp"
			%>

			<%
					}
					//affichage films des semaines suivantes
					else if (request.getParameter("view").equals("next"))
					{
			%>

			<%@
						include file="films_suivants.jsp"
			%>
									
			<%			
					}
				}
				//affcihage séances d'un film
				else
   				{
			%>
